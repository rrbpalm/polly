...
if(DEFINED POLLY_RASPBERRYPI3_CXX17_GCC_PIC_HID_SECTIONS_CMAKE)
  return()
else()
  set(POLLY_RASPBERRYPI3_CXX17_GCC_PIC_HID_SECTIONS_CMAKE 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
    "RaspberryPi 3 / gcc / PIC / c++17 support / hidden / function-sections / data-sections"
    "Unix Makefiles"
)
